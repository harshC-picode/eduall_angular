...
@Component({
  selector: 'app-category-dropdown2',
  standalone: true,
  imports: [CommonModule, Select2],
  templateUrl: './category-dropdown2.component.html',
  styleUrls: ['./category-dropdown2.component.scss']
})
export class CategoryDropdown2Component {
